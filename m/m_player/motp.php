		...
		function fn_otpAccredit() {	 // motp 인증	
            ...
            $.ajax({
                ...
                data:{
                    ...
                    OTPNO     		: USER_OTP, // OTP
                    AGTID			: AGTID, // emon 아이디 (motp 테스트를 위하여 평생교육원꺼로 할수밖에 없음)
                    USRID			: USRID, // 아이디
...
<body>
  ...
  <div class="canvas">
    <h2>MOTP 인증</h2>
		<img src="/m_images/motp.png" alt="인증 이미지">
...
$returnurl = $SiteURL."/m_lib/CheckPlusSafe/checkplus_success_etc.php";	// 성공시 이동될 URL
