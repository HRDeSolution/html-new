...
<script language='javascript'>
	...
	var CLASS_AGENT_PK = "<?=$LectureCode?>,<?=$LectureTerme_idx?>";
			...
			document.form_motp.action = "/m_player/motp.php?class_tme=<?=$Chapter_Number?>&COURSE_AGENT_PK=<?=$LectureCode?>&CLASS_AGENT_PK=<?=$LectureCode?>,<?=$LectureTerme_idx?>"
...
<div id="screenModal" style="">
  <div class="titleArea">
    <div>
      <img src="/m_images/study/img_test01.png">
      <h1>학습자 유의사항</h1>
  ...
  <div class="caution">
    ...
    <table width="100%" style="border:5px solid #000000;">
      <tbody>
        <tr>
          <td>
            <h1>[수강 유의사항]</h1>
  ...
  <div class="mobileCert">
    ...
    <ul>
      <li>
       ...
       &nbsp;&nbsp; 
          <button type="button" onclick="fnPopupmotp(237929,'7Q4VLG',4920);" class="btnPhone">MOTP인증하기</button>&nbsp;&nbsp;
        ...
        <br>
        <span class="red">※ 타인 명의 휴대폰인 경우 공공아이핀을 발급 후 아이핀 인증으로 진행해 주시기 바랍니다. (아이핀/마이핀가입)</span>
	...
	<div class="infoArea">
		...
		<div class="mycheck">
			<ul>
				...
				<li><a href="Javascript:fnPopup3();" style="font-size:30px;">MOTP 인증</a></li>
			</ul>
		</div>
		<!-- area // -->
	</div>
