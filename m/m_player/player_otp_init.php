...
<link rel="stylesheet" type="text/css" href="/m_include/jquery-ui.css" />
<script type="text/javascript" src="/m_include/jquery-1.11.0.min.js"></script>
<script type="text/javascript" src="/m_include/jquery-ui.js"></script>
<script type="text/javascript" src="/m_include/jquery.ui.datepicker-ko.js"></script>
<script type="text/javascript" src="/m_include/function.js"></script>
...
<body>
<?
include "../m_include/login_check_pop.php";
?>
<div id="wrap">
		...
		$.ajax({
			...
			success : function(xml) {					
				if($(xml).find("RetVal").text() == "101") {
					...
					<?if($TestType) {?>
					location.href="/m_player/player_otp_captcha_exam.php?LectureCode=<?=$LectureCode?>&Study_Seq=<?=$Study_Seq?>&Chapter_Seq=<?=$Chapter_Seq?>&TestType=<?=$TestType?>";
					<?}else{?>
					location.href="/m_player/player_otp_captcha.php?Chapter_Number=<?=$Chapter_Number?>&LectureCode=<?=$LectureCode?>&Study_Seq=<?=$Study_Seq?>&Chapter_Seq=<?=$Chapter_Seq?>&Contents_idx=<?=$Contents_idx?>&mode=<?=$mode?>";
					<?}?>
