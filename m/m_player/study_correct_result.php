<?
include "../m_include/include_function.php";
			...
			if($ExamA_idx_array) {
				...
				foreach($ExamA_idx_array as $ExamA_idx_array_value) {
					...
					if($UserAnswer==$Answer) {
						$OX_Style = '<img src="/m_images/common/examresult01.png" alt="정답" class="ml5 vm" />';
						$UserAPoint = $ExamA_Score;
					}else{
						$OX_Style = '<img src="/m_images/common/examresult02.png" alt="오답" class="ml5 vm" />';
						$UserAPoint = 0;
					}
