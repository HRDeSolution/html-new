...
<div class="layerArea wid900">
	...
	<div class="infoArea" style="text-align:center">
		<!-- area -->
		<iframe name='OptCert' id='OptCert' width='870' height='510' src='/m_player/player_otp_captcha.php?Chapter_Number=<?=$Chapter_Number?>&LectureCode=<?=$LectureCode?>&Study_Seq=<?=$Study_Seq?>&Chapter_Seq=<?=$Chapter_Seq?>&Contents_idx=<?=$Contents_idx?>&mode=<?=$mode?>' border='2' frameborder='2' scrolling="no"></iframe>
	</div>
	<!-- info // -->
</div>
<!-- layer 본인인증 // -->
