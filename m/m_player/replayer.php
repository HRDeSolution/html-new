...
if($ContentsDetail_count>1) { //하부 컨텐츠가 2개 이상인 경우
	...
	$PlayerFunction = "<div style='background-color:#fff; text-align:center; width:1020px; height:655px' id='MultiContents'><br><br><br><br><br><br><br><br><br><img src='/m_images/loader.gif' alt='로딩중' /></div>";

}else{ //하부 컨텐츠가 1개인 경우

	if($ContentsType=="A") { //플레쉬 강의의 경우
	    if(strpos($ContentsURL, "https://") === false){
...
<div class="eduPlayer">
	...
	<div class="infoArea">
		...
		<div class="btn">
			...
			<span><?if($attachFile) {?><a href="/m_player/lecture_download.php?LectureCode=<?=$LectureCode?>" target="ScriptFrame">학습자료 다운로드</a><?}?></span>
		</div>
		<!-- btn // -->
	</div>
	<!-- info // -->
