...
<div class="layerArea wid550">
	<!-- close -->
	<div class="close"><a href="Javascript:PlayInfoClose();"><img src="/m_images/common/btn_close01.png" alt="창닫기" /></a></div>
	<!-- title -->
	...
	<div class="infoArea">
		...
		<div class="comment_1">
			<ul>
				<li>질문내용은 강사님 확인 후 <span class="fcSky01B">학습지원센터 &gt; 1:1 문의</span>에서 확인하실 수 있습니다.</li>
			</ul>
		</div>
		<form name="CounselForm" method="POST" action="/m_player/study_counsel_ok.php" target="ScriptFrame">
