...
?>
		...
		<div class="view viewBack01">
			...
			<!-- btn -->
			<div class="btn"><a href="Javascript:MultiContentsView('<?=$Chapter_Number?>','<?=$LectureCode?>','<?=$Study_Seq?>','<?=$Chapter_Seq?>','<?=$Contents_idx?>','<?=$ContentsDetail_Seq?>','1');"><img src="/m_images/player/pageview_btn_play.png" alt="강의듣기" /></a></div>
			<!-- view info // -->
		</div>
		<!-- view // -->
<?
...
?>
		...
		<div class="testView">
			...
			<ul>
				...
				<?}?>
				<br>
				<p class="mt20 tc"><a href="Javascript:MultiPlayerExamType01Result();" id="MultiPlayerExamType01_01"><img src="/m_images/player/pageview_btn_submit.png" alt="정답확인" /></a></p>
		...
		<div class="testView">
			...
			<ul>
				...
				<li class="examTxt"><input name="Answer2" id="Answer2" type="text" />
					<p class="mt20 tc"><a href="Javascript:MultiPlayerExamType02Result();" id="MultiPlayerExamType02_01"><img src="/m_images/player/pageview_btn_submit.png" alt="정답확인" /></a></p>
				</li>
...
?>
		...
		<div class="view viewBack04">
			...
			<!-- btn -->
			<div class="btn"><a href="Javascript:StudyProgressCheck('End','Y');"><img src="/m_images/player/pageview_btn_end.png" alt="강의종료" /></a></div>
			<!-- view info // -->
		</div>
		<!-- view // -->
<?
...
?>
		<!-- control -->
		<div class="control">
			<span class="pr10"><a href="Javascript:MultiContentsView('<?=$Chapter_Number?>','<?=$LectureCode?>','<?=$Study_Seq?>','<?=$Chapter_Seq?>','<?=$Contents_idx?>','<?=$ContentsDetail_Seq?>','0');"><img src="/m_images/player/pagecontrol_btn_first.png" alt="처음으로" /></a></span>
			<span class="arrBtn"><?if($PlayNum>0) {?><a href="Javascript:MultiContentsView('<?=$Chapter_Number?>','<?=$LectureCode?>','<?=$Study_Seq?>','<?=$Chapter_Seq?>','<?=$Contents_idx?>','<?=$ContentsDetail_Seq?>','<?=$PlayNum-1?>');"><img src="/m_images/player/pagecontrol_page_prev.png" alt="이전" /></a><?}?></span>
			<span class="pageNo"><strong><?=$PlayNum+1?></strong>/<?=$Content_count?></span>
			<span class="arrBtn"><?if($PlayNum<$Content_count-1) {?><a href="Javascript:MultiContentsView('<?=$Chapter_Number?>','<?=$LectureCode?>','<?=$Study_Seq?>','<?=$Chapter_Seq?>','<?=$Contents_idx?>','<?=$ContentsDetail_Seq?>','<?=$PlayNum+1?>');"><img src="/m_images/player/pagecontrol_page_next.png" alt="다음" /></a><?}?></span>
		</div>
		<!-- control // -->
