...
<!-- <form name="CounselAskForm" method="POST" action="/m_public/support/counsel_ask_ok.php" target="ScriptFrame"> -->
...
<div id="modal01" class="modal-wrap2">
    ...
    <h2>상담 문의 등록</h2>
    <form name="CounselForm" method="POST" enctype="multipart/form-data" action="/m_public/support/ask_ok.php" target="ScriptFrame">
	    ...
	    <div class="input_wrap">
		    ...
		    <div class="input_box captcha_box">
	            <div class="captcha"><img src="/m_include/make_image.php" alt=""></div>
