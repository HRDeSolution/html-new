...
<meta property="og:image" content="https://www.hrdeedu.com/m_images/site/header.png?ver=230207" />
...
<!-- <script type="text/javascript" src="/m_include/jquery-3.5.1.min.js"></script> -->
...
<script type="text/javascript" src="/m_include/jquery.bxslider.min.js"></script>
<script type="text/javascript">
<!--
...
?>
		...
		<div id="header">
	    	...
	    	<div class="topHead">
                ...
                <!-- banner -->
                <!-- <div class="banner"><a href="#" class="fsz"><img src="../m_images/imsi01.jpg" alt="" /></a></div> -->

                <!--logo -->
                <h1><a href="/"><img src="../m_images/site/header.png" alt="<?=$SiteName?>" /></a></h1>
            ...
            <div class="topNavi">
                ...
                <div class="area">
                    ...
                    <!-- total menu -->
                    <div class="tmenu"><a href="Javascript:SiteMenuShow();" id="SiteMenuBtn"><img src="../m_images/common/topnavi_btn_tmenu.png" alt="전체메뉴보기" /></a></div>
