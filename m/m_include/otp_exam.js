				...
				*/
				...
				if(ConnStatus == "101") {
					if(OtpStatus == "101" || OtpStatus == "103") {
						...
						location.href="/m_player/player_otp_init.php?LectureCode="+LectureCode+"&Study_Seq="+Study_Seq+"&Chapter_Seq="+Chapter_Seq+"&TestType="+TestType;
					}
					else {
		...
		$.ajax({
			...
			success : function(xml) {					
				if($(xml).find("RetVal").text() == "101") {
					...
					$.post("/m_player/player_captcha_time.php",
					{
