...
class Page
{
	...
	function blockList()
	{
		...
		for($i = 0; $i < count($arrBlock); $i++)
		{
			...
			{
				$block_str .= '<span><a href="javascript:MainLectureView('. $arrBlock[$i] . ');" ><img src="../m_images/main/course_page02.png" alt="' . $arrBlock[$i] . '페이지" /></a></span>';
			}
			else
			{
				$block_str .= '<span><a href="javascript:MainLectureView('. $arrBlock[$i] . ');" ><img src="../m_images/main/course_page01.png" alt="' . $arrBlock[$i] . '페이지" /></a></span>';
			}
