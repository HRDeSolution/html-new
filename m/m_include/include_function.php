...
$UPLOAD_DIR = "/web/hrde/html/m/upload";
$HomeDirectory = "/web/hrde/html/m";

$SiteURL 			= $Protocol_SSL."m.hrdeedu.co.kr";
$MobileSiteURL 		= $Protocol_SSL."m.hrdeedu.co.kr";

$MobileAuthURL 		= $Protocol_SSL."hrdeedu.co.kr/"; //모바일 인증 도메인
$FlashServerURL 	= $Protocol_SSL."m.hrdeedu.co.kr/contents";
$MovieServerURL		= $Protocol_SSL."m.hrdeedu.co.kr/contents";
$MobileServerURL 	= $Protocol_SSL."m.hrdeedu.co.kr/contents";

$Auth_Mobile_path 	= $HomeDirectory."/m_lib/CheckPlusSafe/64bit/CPClient_64bit"; //휴대폰 본인인증 모듈 경로
$Auth_IPIN_path 	= $HomeDirectory."/m_lib/NiceIPIN/64bit/IPIN2Client"; //아이핀 본인인증 모듈 경로
...
function StarPointViewA($StarPoint) {
    $StarImgOn = "<img src='/m_common/img/star_fill.png' alt='' style='width: 20px;'/>";
    $StarImgOff = "<img src='/m_common/img/star.png' alt='' style='width: 20px;'/>";
...
function StarPointViewB($StarPoint) {
    $StarImgOn = "<img src='/m_common/img/star_fill.png' alt='' style='width: 15px;'/>";
    $StarImgOff = "<img src='/m_common/img/star.png' alt='' style='width: 15px;'/>";
...
function StarPointViewC($StarPoint) {
    $StarImgOn = "<img src='/m_common/img/star_fill.png' alt='' style='width: 25px;'/>";
    $StarImgOff = "<img src='/m_common/img/star.png' alt='' style='width: 25px;'/>";
...
function StarPointView($StarPoint) {
    $StarImgOn = "<img src='/m_images/common/icon_review_star03.png' alt='' />";
    $StarImgOff = "<img src='/m_images/common/icon_review_star01.png' alt='' />";
...
function StarPointAVG($StarPoint) {
    $StarImgOn = "<img src='/m_images/common/icon_review_star03.png' />";
    $StarImgHalf = "<img src='/m_images/common/icon_review_star02.png' />";
    $StarImgOff = "<img src='/m_images/common/icon_review_star01.png' />";
