		<div id="Footer">
            ...
            <!-- side // -->
           	<!-- logo copy mark -->
           	<div class="copyArea">
            	<h1><img src="../m_images/site/footer.png" alt="<?=$SiteName?>" /></h1>
                <!-- copy -->
                <div class="copy">
            ...
            <!-- logo copy mark // -->
            <div class="topBtn"><a href="Javascript:MoveTop();"><img src="../m_images/common/btn_top.png" alt="페이지 위로" /></a></div>
         </div>
         <!-- Footer // -->
...
<div id="Roading" style="display:none;z-index:100"><BR /><BR /><BR /><BR /><img src="/m_images/loader.gif" alt="로딩중" /></div>
