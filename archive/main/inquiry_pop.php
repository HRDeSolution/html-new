...
<div id="modal01" class="modal-wrap">
    ...
    <h2 class="modal-title">
        수강신청
        <span class="subtitle"><strong>_</strong>교육이 등록되지않은 기업담당자만 신청해주세요</span>
    </h2>

    <form name="InquiryForm" method="POST" action="/archive/main/inquiry_ok.php" target="ScriptFrame">
        <div class="input_wrap mt50">
            <p class="title">문의 종류</p>
            <div class="input_box">
                <select name="ServiceType" id="ServiceType" class="input-type">
                	<option value="1">HRDe아카이브</option>
                </select>
            </div>
        </div>
