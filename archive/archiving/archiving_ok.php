...
$sql = "INSERT INTO Archiving(ID, Title, Contents, RegDate, FileName1, RealFileName1, Status, Del)
        VALUES('$LoginMemberID', '$Title', '$Content', NOW(), '$FileName1', '$RealFileName1', 'A', 'N')";   
