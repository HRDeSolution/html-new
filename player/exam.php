...
if($MobileAuth_count=='a' && $MobileAuth_count<1 && ($ServiceType==1 || $ServiceType==4)) { //과정 인증내역이 없으면 본인인증 필요 (과정당 1회만 인증)
?>
...
<div class="layerArea wid450" id="ResultConfirm" style="display:none">
	<!-- close -->
	<div class="close"><a href="Javascript:ExamSubmitCancel();"><img src="img/btn_close01.png" alt="창닫기" /></a></div>
	<!-- title -->
