...
<? $LoginMemberID = Replace_Check_XSS2($loginId); //순서 변경 금지?>
<? include "../../include/include_ability_data.php"; ?>
...
<head>
    ...
    <link rel="stylesheet" href="css/mypage.css?ver=250218">
    ...
    <script type="text/javascript" src="/include/function.js?t=<?=date('YmdHis')?>"></script>
        ...
        <div class="close-btn" onclick="javascript:DataResultClose();" style="float:right">
            <i class="ph-thin ph-x cp" style="font-size:30px"></i>
        </div>
        <div class="mypage_content" style="padding-left:0">
            <div class="content">
                <h3><?=$ROWM['Name'];?>님의 역량진단결과 요약</h3>
                <!--진단결과 그래프-->
                <!--종합점수-->
                ...
                <div class="grid-box">
                    ...
                    <div class="chart2-container">
                        ...
                        <div class="chart">
                            ...
                            <div class="bar-container">
                                <div class="bar bar-2" id="score2_2"></div>
                            </div>
                    ...
                    <div class="chart2-container">
                        ...
                        <div class="chart">
                            ...
                            <div class="bar-container">
                                <div class="bar bar-2" id="score4_2"></div>
                            </div>
                    ...
                    <div class="chart2-container">
                        ...
                        <div class="chart">
                            ...
                            <div class="bar-container">
                                <div class="bar bar-2" id="score3_2"></div>
                            </div>
                ...
                <div class="result-table pt30">
                    <table>
                        ...
                        <tbody>
                            <tr>
                                <th>사전 역량 진단</th>
                                <td><?=(is_null($ROWM['AbilityDate'])) ? "-" : (new DateTime($ROWM['AbilityDate']))->format('Y.m.d');?></td>
                                <td id="average_b0"><b></b></td>
                                <td id="average_bC"><b></b></td>
                                <td id="average_bL"><b></b></td>
                                <td id="average_bJ"><b></b></td>
                             
                            </tr>
                            <tr>
                                <th>사후 역량 진단</th>
                                <td><?=(is_null($ROWM['AbilityAfterDate'])) ? "-" : (new DateTime($ROWM['AbilityAfterDate']))->format('Y.m.d');?></td>
                                <td id="average_a0"><b></b></td>
                                <td id="average_aC"><b></b></td>
                                <td id="average_aL"><b></b></td>
                                <td id="average_aJ"><b></b></td>
                          
                            </tr>
                            <tr>
                                <th>사전 대비 점수변화</th>
                                <td>-</td>
                                <td id="average_tot0"><b></b></td>
                                <td id="average_totC"><b></b></td>
                                <td id="average_totL"><b></b></td>
                                <td id="average_totJ"><b></b></td>
