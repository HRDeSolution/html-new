        ...
        <div class="conZone">
        	<form name="search" id="search" method="POST">
            	...
            	<div class="neoSearch">
					...
					<li>
						<span class="item01">사전</span>
						<select name="AbilityYN" id="AbilityYN" style="width:150px">
							<option value="">전체</option>
					...
					<li>
						<span class="item01">사후</span>
						<select name="AbilityAfterYN" id="AbilityAfterYN" style="width:150px">
							<option value="">전체</option>
							<option value="Y">Y</option>
							<option value="N">N</option>
						</select>
