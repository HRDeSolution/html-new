    			...
    			<div class="neoSearch">
    				<ul class="search">
    					...
    					<li>
                            ...
                            <span id="SearchGubunResult2" style="display:none"><input type="text" name="CompanyName" id="CompanyName" style="width:450px" placeholder="사업주명 입력" onfocus="CompanySearchAutoCompleteGo('B');" onKeyup="CompanySearchAutoCompleteGo('B');"></span>
						...
						<li>
						<span class="item01">IP</span>
							<input type="text" name="ip_addr" id="ip_addr" style="width:200px">
						</li>
    				</ul>
    				<ul class="search">
                    ...
                    <!-- btn -->
    			  	<div class="mt10 tc pb5">
                    	<button type="button" name="SearchBtn" id="SearchBtn" class="btn btn_Blue" style="width:200px;" onclick="StudyIPSearch2(1)"><i class="fas fa-search"></i> 검색</button>&nbsp;&nbsp;	
    					<button type="button" name="ExcelBtn" id="ExcelBtn" class="btn btn_Green line" style="width:200px;" onclick="StudyIPExcel2();"><i class="fas fa-file-excel"></i> 검색 결과 엑셀 출력</button>
    					<!-- 
