...
if($mode=="New") {
	...
	$Sql = "INSERT INTO CourseCategory(idx, ParentCategory, Deep, CategoryName, OrderByNum, UseYN, Del) 
...
//수정---------------------------------------------------
if($mode=="Edit") {
	$Sql = "UPDATE CourseCategory SET ParentCategory=$ParentCategory, Deep=$Deep, CategoryName='$CategoryName', OrderByNum=$OrderByNum, UseYN='$UseYN' WHERE idx=$idx";
	$Row = mysqli_query($connect, $Sql);
