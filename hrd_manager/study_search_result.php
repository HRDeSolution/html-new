...
<table width="100%" cellpadding="0" cellspacing="0" class="list_ty01 gapT20">
	...
	<tr>
		...
		<td align="center" bgcolor="#FFFFFF" class="text01"><?if($ServiceType == "A") echo "패키지(환급)";  else  echo "비환급";?></td>
        ...
        <td align="center" bgcolor="#FFFFFF" class="text01"><?=(($AbilityYN)=='Y'?'Y':(($AbilityYN)=='N'?'N':'-'))?></td>
        <td align="center" bgcolor="#FFFFFF" class="text01"><?=(($AbilityAfterYN)=='Y'?'Y':(($AbilityAfterYN)=='N'?'N':'-'))?></td>
	</tr>
	<?
		}
	}else{
