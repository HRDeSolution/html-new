    ...
    <div class="contentBody">
        ...
        <div class="conZone">
			...
			<form name="search" method="get">
                <div class="searchPan">
					<select name="col">
						<option value="ContentsTitle" <?if($col=="ContentsTitle") { echo "selected";}?>>문항명</option>
						<option value="Expl01" <?if($col=="Expl01") { echo "selected";}?>>이름</option>
						<option value="Expl02" <?if($col=="Expl02") { echo "selected";}?>>번호</option>
					</select>
            ...
            <table width="100%" cellpadding="0" cellspacing="0" class="list_ty01 gapT20">
                ...
                <tr data-idx = '<?=$idx?>'>
					...
					<td class="text01"><?=$aDepth?></td>
                    <td class="text01"><?=$aGroup?></td>
					<td class="tl text01"><A HREF="Javascript:readRun('<?=$idx?>');"><?=$aValue?></A></td>
