<?
$MenuType = "D";
$PageName = "ability_manager";
$ReadPage = "ability_manager_read";
?>
    ...
    <div class="contentBody">
        ...
        <div class="conZone">
			...
			<form name="search" method="get">
                <div class="searchPan">
					<select name="col">
						<option value="aValue" <?if($col=="aq.aValue") { echo "selected";}?>>문항명</option>
            ...
            <table width="100%" cellpadding="0" cellspacing="0" class="list_ty01 gapT20">
                ...
                <tr data-idx = '<?=$idx?>'>
                    ...
                    <td class="text01"><?=$abilityBind_array[$aBind]?></td>
					<td class="text01"><?=$aValue2?></a></td>
                    <td class="text01"><?=($aType == "A" && $aDepth == "step02") ? str_repeat('★ ', $aValue) : $abilityValue_array[$aValue]?></td>
