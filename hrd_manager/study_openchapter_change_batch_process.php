...
$OpenChapter = Replace_Check($OpenChapter);
...
$Sql_Input = "UPDATE Study SET LectureTerme_idx=$LectureTerme_idx, OpenChapter=$OpenChapter, StudyKey='$StudyKey' WHERE Seq=$Seq";
