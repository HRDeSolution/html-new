	...
	if($lmsSheetIndex===1){	
		...
		*/
		...
		if($CompanyName && $CompanyCode) {
			...
			$Sql = "INSERT INTO CompanyExcelTemp (idx, ID, CompanyName, CompanyID, CompanyScale, CompanyCode, HRD, Ceo, Zipcode, Address01, Address02, Uptae, Upjong, Tel, Email,
                                EduManager, EduManagerPhone, EduManagerEmail, SalesManager, Remark, CyberEnabled, Tel2, Fax2, CSEnabled, RegDate) 
					VALUES($maxno, '$LoginAdminID', '$CompanyName', '$CompanyID', '$CompanyScale', '$CompanyCode', '$HRD', '$Ceo', '$Zipcode', '$Address01', '$Address02', '$Uptae', '$Upjong', '$Tel', '$Email',
                           '$EduManager', '$EduManagerPhone', '$EduManagerEmail', '$SalesManager', '$Remark', '$CyberEnabled', '$Tel2', '$Fax2', '$CSEnabled', NOW())";
		...
		for($i = 2; $i <= $maxRow; $i++) {
			...
			*/
			...
			if($CompanyName && $CompanyCode) {
			    //임시 테이블에 등록
				$maxno = max_number("idx","CompanyExcelTemp");
				$Sql = "INSERT INTO CompanyExcelTemp (idx, ID, CompanyName, CompanyID, CompanyScale, CompanyCode, HRD, Ceo, Zipcode, Address01, Address02, Uptae, Upjong, 
						...
						VALUES($maxno, '$LoginAdminID', '$CompanyName', '$CompanyID', '$CompanyScale', '$CompanyCode', '$HRD', '$Ceo', '$Zipcode', '$Address01', '$Address02', '$Uptae', '$Upjong',
                               '$Tel', '$Email', '$EduManager', '$EduManagerPhone', '$EduManagerEmail', '$SalesManager', '$Remark', '$CyberEnabled', '$Tel2', '$Fax2', '$CSEnabled', '$CompanyManageCode', NOW())";
				$Row = mysqli_query($connect, $Sql);
