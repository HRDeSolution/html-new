...
if($mode=="new") {
	...
	$Sql = "INSERT INTO Notice 	(idx, UseYN, Notice, Title, Content, FileName1, RealFileName1, FileName2, RealFileName2, FileName3, RealFileName3, FileName4, RealFileName4, FileName5, RealFileName5, ViewCount, Del, RegDate) 
			VALUES ($maxno, '$UseYN', '$Notice', '$Title', '$Content', '$FileNameA1', '$RealFileNameA1', '$FileNameA2', '$RealFileNameA2', '$FileNameA3', '$RealFileNameA3', '$FileNameA4', '$RealFileNameA4', '$FileNameA5', '$RealFileNameA5', 0, 'N', NOW())";
