...
if($sw) if($col=="") $where[] = ""; else $where[] = "$col LIKE '%$sw%'";
$where[] = "Del='N'";
...
##-- 검색 등록수
$Sql = "SELECT COUNT(*) FROM Inquiry $where";
	...
	<div class="contentBody">
        ...
        <div class="conZone">
            ...
            <table width="100%" cellpadding="0" cellspacing="0" class="list_ty01 gapT20">
				...
				<?
				$SQL = "SELECT * FROM Inquiry $where $str_orderby LIMIT $PAGE_CLASS->page_start, $page_size";
				//echo $SQL;
