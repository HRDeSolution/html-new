...
$Sql = "SELECT *, (SELECT Name FROM StaffInfo WHERE ID=Company.SalesManager) AS SalesName FROM Company WHERE CompanyCode='$CompanyCode' AND Del='N'";
//echo $Sql;
	...
	<div class="contentBody">
		...
		<div class="conZone">
        	<table width="100%" cellpadding="0" cellspacing="0" class="view_ty01">
				...
				<tr>
					<th>회사 규모</th>
					<td width="18%" > <?=$CompanyScale_array[$CompanyScale]?></td>
					<th>회사명</th>
					<td width="18%" > <?=$CompanyName?></td>
					<th>사업자<br>번호</th>
					<td width="18%" > <?=$CompanyCode?></td>
					<th>HRD 번호</th>
					<td width="18%" > <?=$HRD?></td>
				</tr>
				<tr>
			...
			<div id="LoginHistory" style="left:10px; top:20px; width:100%; height:200px; z-index:1; overflow: auto; overflow-x:hidden;">
				<table width="100%" cellpadding="0" cellspacing="0" class="list_ty01 gapT20">
        			...
        			<?
        			$i = 1;
        			$SQL = "SELECT DISTINCT a.LectureStart, a.LectureEnd FROM Study AS a LEFT OUTER JOIN Company AS b ON a.CompanyCode=b.CompanyCode WHERE a.CompanyCode='$CompanyCode' AND a.ServiceType = 'A' ORDER BY a.LectureStart ASC, a.LectureEnd ASC";
        			//echo $SQL;
        			...
        			?>
        			<tr>
        				<td align="center"  colspan="20">수강 정보가 없습니다.</td>
        			</tr>
        			<? } ?>
				</table>
        	</div>
        
        	<div class="btnAreaTl02"><span class="fs16b fc333B sub_title2">수강생 정보</span></div>        
        	<div id="LoginHistory" style="left:10px; top:20px; width:100%; height:300px; z-index:1; overflow: auto; overflow-x:hidden;">
        		<table width="100%" cellpadding="0" cellspacing="0" class="list_ty01 gapT20">
        			...
        			?>
        			<tr>
        				<td align="center"  colspan="12">수강생 정보가 없습니다.</td>
        			</tr>
        			<? } ?>
       			</table>
			</div>
