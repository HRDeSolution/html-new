	...
	<div class="contentBody">
		...
		<div class="conZone">
			...
			<div class="btnAreaTr02">
				<button type="button" name="ExcelBtn" id="ExcelBtn" class="btn btn_Green line" onclick="location.href='contents_like_excel.php?col=<?=$col?>&sw=<?=$sw?>'"><i class="fas fa-file-excel"></i> 검색항목 엑셀 출력</button>
          	</div>
