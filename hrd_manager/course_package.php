...
if($sw){
	if($col=="") {
	    ...
	    if($col=="LectureCode") $where[] = "a.LectureCode='$LectureCode'";
...
##-- 정렬조건
if($orderby=="") $str_orderby = "ORDER BY a.RegDate DESC, a.idx DESC";
    ...
    <div class="contentBody">
        ...
        <div class="conZone">
			...
			<div class="btnAreaTr02">
          	...
          	<b style="color:red;">** 패키지 컨텐츠는 1개만 사용 가능합니다.</b>
            <table width="100%" cellpadding="0" cellspacing="0" class="list_ty01 gapT20">
				...
				?>
              	<tr>
    				...
    				<td align="left"><A HREF="Javascript:readRun('<?=$idx?>');"><strong><?=$ContentsName?></strong></A></td>
