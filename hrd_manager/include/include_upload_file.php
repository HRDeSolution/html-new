...
<?
	...
	checkFileSecure($file, $file_name, function($msg) {
		echo "<script>alert('".addslashes($msg)."'); top.DataResultClose();</script>";
	});
...
<?
	...
	checkFileSecure($file2, $file2_name, function($msg) {
		echo "<script>alert('".addslashes($msg)."'); top.DataResultClose();</script>";
	});
...
<?
	...
	checkFileSecure($file3, $file3_name, function($msg) {
		echo "<script>alert('".addslashes($msg)."'); top.DataResultClose();</script>";
	});
...
<?
	...
	checkFileSecure($file4, $file4_name, function($msg) {
		echo "<script>alert('".addslashes($msg)."'); top.DataResultClose();</script>";
	});
...
<?
	...
	checkFileSecure($file5, $file5_name, function($msg) {
		echo "<script>alert('".addslashes($msg)."'); top.DataResultClose();</script>";
	});
