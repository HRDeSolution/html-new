...
<?
if(strpos($_SERVER["HTTP_HOST"],"tutor") > -1)  $Title = "교강사 관리자모드";
else $Title = "관리자모드";
?>
			...
			<div class="loginForm">
				...
				<div class="Login">
					...
					<ul>
						...
						<li class="input_box"><input type="text" name="ID" id="ID" onblur="FocusSend();" value="<?=$_COOKIE["AdminSavedID"]?>" autocomplete="off" placeholder="아이디 입력" /><label for="ID"><i class="ph ph-user"></i></label></li>
						<li class="input_box"><input type="password" name="Passwd" id="Passwd" autocomplete="off" placeholder="비밀번호 입력" /><label for="Passwd"><i class="ph ph-lock"></i></label></li>
						<li class="input_box"><input type="password2" name="Passwd2" id="Passwd2" autocomplete="off" placeholder="2차인증 확인(회원정보 4자리)" /><label for="Passwd"><i class="ph ph-key"></i></label></li>
