...
foreach($seq_array as $seq) {
	...
	if($QUERY && mysqli_num_rows($QUERY)){
		while($ROW = mysqli_fetch_array($QUERY)){
			...
			$subject = "[아카이브] 오리엔테이션/사업주훈련매뉴얼_교육담당자용 ".$ContentsName;
			$Massage = "";
			...
			if($Row) {
				...
				$Massage = "<div style='width:800px; margin:0 auto; padding-bottom:40px;'>
                				<p><img src='https://www.hrdeedu.co.kr/images/visual_img01.jpg' /></p>
                				...
                				<div style='margin-top:40px; font-size:16px; line-height:1.8em;'>
                					...
                					<ul>
                						<li><a href='https://www.hrdeedu.co.kr'>https://www.hrdeedu.co.kr</a> 교육사이트를 통해 부여 받은 아이디/비밀번호로 로그인 후 교육 및 평가 진행<br>(휴대폰으로 아이디/비밀번호 전송예정) 자세한 내용은 첨부 자료 확인</li>
                					...
                					<ul>
                						<li>시험중 정전 등 사유로 컴퓨터가 꺼지더라도 시험 시작후 #{시험시간} 분 이내면 재로그인 후 재응시 가능합니다.<br>(기존 저장한 답은 자동저장)</li>
                					...
                					<ul style='line-height:2em;'>
                						<li>
                                            <a href='https://www.hrdeedu.co.kr/hrd_manager/direct_download.php?code=email&file=HRDe_4_교육담당자 매뉴얼.pdf' style='text-decoration:none; color:#000;'>교육담당자 매뉴얼 
                							 <span style=' margin-left:5px; background:#059be3; color:#fff; line-height:normal; padding:3px 10px; display:inline-block; -webkit-border-radius:4px; -moz-border-radius:4px; border-radius:4px;'>다운로드</span>
                                            </a><br><br>
                						</li>
                						<li>
                                            <a href='https://www.hrdeedu.co.kr/hrd_manager/direct_download.php?code=email&file=HRDe_2_학습자 매뉴얼_오리엔테이션_저용량.pdf' style='text-decoration:none; color:#000;'>학습자 매뉴얼 
                							 <span style=' margin-left:5px; background:#059be3; color:#fff; line-height:normal; padding:3px 10px; display:inline-block; -webkit-border-radius:4px; -moz-border-radius:4px; border-radius:4px;'>다운로드</span>
                                            </a><br><br>
                						</li>
                						<li>
                                            <a href='https://www.hrdeedu.co.kr/hrd_manager/direct_download.php?code=email&file=HRDe_5_본인인증 매뉴얼.pdf' style='text-decoration:none; color:#000;'>본인인증 매뉴얼 
                							 <span style=' margin-left:5px; background:#059be3; color:#fff; line-height:normal; padding:3px 10px; display:inline-block; -webkit-border-radius:4px; -moz-border-radius:4px; border-radius:4px;'>다운로드</span>
                                            </a><br><br>
                						</li>
                						<li>
                                            <a href='https://www.hrdeedu.co.kr/hrd_manager/direct_download.php?code=email&file=HRDe_6_MOTP인증 매뉴얼.pdf' style='text-decoration:none; color:#000;'>mOTP 매뉴얼 
                							 <span style=' margin-left:5px; background:#059be3; color:#fff; line-height:normal; padding:3px 10px; display:inline-block; -webkit-border-radius:4px; -moz-border-radius:4px; border-radius:4px;'>다운로드</span>
                                            </a><br><br>
                						</li>
                						<li>
                                            <a href='https://www.hrdeedu.co.kr/mylecture/lecture_download.php?LectureCode=#{강의코드}' style='text-decoration:none; color:#000;'>[학습자료] #{강의명}
                							 <span style=' margin-left:5px; background:#059be3; color:#fff; line-height:normal; padding:3px 10px; display:inline-block; -webkit-border-radius:4px; -moz-border-radius:4px; border-radius:4px;'>다운로드</span>
                                            </a>
                						</li>
                					</ul>
			...
			$SqlI = "INSERT INTO EmailSendLogForEduManager( CompanyCode,  MassageTitle, Massage, Code, Email, InputID, RegDate)
                    VALUES('$CompanyCode' , '$subject', '$subject', 'N', '$EduManagerEmail', '$LoginAdminID', NOW())";
