...
##-- 정렬조건
if($orderby=="") {
	$str_orderby = "ORDER BY a.RegDate DESC";
}else{
	$str_orderby = "ORDER BY $orderby";
}
##-- 검색 등록수
$Sql = "SELECT COUNT(*) FROM NegativeTraining a LEFT OUTER JOIN Company AS b ON a.CompanyCode=b.CompanyCode $where";
            ...
            <div class="conZone">
                ...
                <table width="100%" cellpadding="0" cellspacing="0" class="list_ty01 gapT20">
                  ...
                  <tr>
					...
					<?
					$SQL = "SELECT a.idx, a.Content, a.CompanyCode, b.CompanyName, a.RegDate
							FROM NegativeTraining a  
                  ...
                  <tr>
					<td><?=$PAGE_UNCOUNT--?></td>
					<td><?=$CompanyName?></td>
					<td style="text-align:left"><A HREF="Javascript:readRun('<?=$idx?>');"><?=$Content?></A></td>
					<td><?=$RegDate?></td>
                  </tr>
                  <?
						}
