...
<div class="btnAreaTl02">
	...
	&nbsp;&nbsp;&nbsp;&nbsp;<?if($AdminWrite=="Y") {?><input type="button" value="추가 하기" class="btn_inputLine01" onclick="ChapterRegist('new','<?=$LectureCode?>','','Y', 'Course');"><?}?>
	<button type="button" name="ExcelBtn" id="ExcelBtn" class="btn btn_Green" onClick="location.href='chapter_write_excel.php'"><i class="fas fa-file-excel"></i> 엑셀로 등록</button>
...
<tr bgcolor="<?=$Bgcolor?>">
	...
	<td><?=$SubCount?></td>
	<?if($AdminWrite=="Y") {?>
	<td><input type="button"  value="수정" class="btn_inputSm01" onclick="ChapterRegist('edit','<?=$LectureCode?>','<?=$Chapter_seq?>','Y', 'Course');"></td>
