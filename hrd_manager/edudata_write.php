...
if($mode!="new") {
	...
	$Sql = "SELECT * FROM StudyPDS WHERE idx=$idx";
...
?>
                ...
                <!-- 입력 -->
				<form name="Form1" method="post" action="edudata_script.php" enctype="multipart/form-data" target="ScriptFrame">
                ...
                <table width="100%" cellpadding="0" cellspacing="0" class="view_ty01">
                  ...
                  <tr>
					...
					<tr>
						<th>첨부된 파일 1</th>
						<td><A HREF="./download.php?idx=<?=$idx?>&code=StudyPDS&file=1"><?=$RealFileName1?></A>&nbsp;&nbsp;<input type="checkbox" name="FileDel1" value="Y"> 현재 파일 삭제</td>
					</tr>
					<? } ?>
					<tr>
						<th>첨부파일 2</th>
					...
					<tr>
						<th>첨부된 파일 2</th>
						<td><A HREF="./download.php?idx=<?=$idx?>&code=StudyPDS&file=2"><?=$RealFileName2?></A>&nbsp;&nbsp;<input type="checkbox" name="FileDel2" value="Y"> 현재 파일 삭제</td>
					</tr>
					<? } ?>
					<tr>
						<th>첨부파일 3</th>
					...
					<tr>
						<th>첨부된 파일 3</th>
						<td><A HREF="./download.php?idx=<?=$idx?>&code=StudyPDS&file=3"><?=$RealFileName3?></A>&nbsp;&nbsp;<input type="checkbox" name="FileDel3" value="Y"> 현재 파일 삭제</td>
					</tr>
					<? } ?>
					<tr>
						<th>첨부파일 4</th>
					...
					<tr>
						<th>첨부된 파일 4</th>
						<td><A HREF="./download.php?idx=<?=$idx?>&code=StudyPDS&file=4"><?=$RealFileName4?></A>&nbsp;&nbsp;<input type="checkbox" name="FileDel4" value="Y"> 현재 파일 삭제</td>
					</tr>
					<? } ?>
					<tr>
						<th>첨부파일 5</th>
					...
					<tr>
						<th>첨부된 파일 5</th>
						<td><A HREF="./download.php?idx=<?=$idx?>&code=StudyPDS&file=5"><?=$RealFileName5?></A>&nbsp;&nbsp;<input type="checkbox" name="FileDel5" value="Y"> 현재 파일 삭제</td>
					</tr>
					<? } ?>
