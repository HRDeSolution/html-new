...
$(document).ready(function() {
    ...
    <div class="contentBody">
    	<h2>학습내역관리<span class="fs12 description">아카이브 패키지/비패키지 과정 세부 수강 데이터를 확인합니다.</span></h2>
        <div class="conZone">
        	<form name="search" id="search" method="POST">
            	<input type="hidden" name="SubmitFunction" id="SubmitFunction" value="Study2Search(1)">
            	...
            	<div class="neoSearch">
                    ...
                    <ul class="search">
            			<li>
                        	...
                        	<select name="LectureCode" id="LectureCode" >
            					...
            					<?
            					$SQL = "SELECT * FROM Course WHERE Del='N' AND PackageYN = 'Y' ORDER BY ContentsName ASC";
            		...
            		<div class="mt10 tc pb5">
                    	<button type="button" name="SearchBtn" id="SearchBtn" class="btn btn_Blue" style="width:200px;" onclick="Study2Search(1)"><i class="fas fa-search"></i> 검색</button>
                    	<button type="button" name="ExcelBtn" id="ExcelBtn" class="btn btn_Green line" style="width:200px;" onclick="Study2Excel();">검색 결과  <i class="fas fa-file-excel"></i> 엑셀 출력</button>					
            		</div>
                    <!-- btn // -->
            	</div>
        	</form>
