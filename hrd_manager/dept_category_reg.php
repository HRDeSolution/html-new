                    ...
                    <td>
    					<table width="100%" cellpadding="0" cellspacing="0" class="view_ty01">
    						<tr>
    							...
    							<td><input type="checkbox" name="TopMenuGrant01" id="TopMenuGrant05" value="E" <?if(in_array('E',$TopMenuGrant_array)){?>checked<?}?>> <label for="TopMenuGrant05"><strong>아카이브</strong></label></td>
    						</tr>
    						<tr>
    							<td valign="top">
        							...
        							<input type="checkbox" name="SubMenuGrant01" id="SubMenuGrant01_08" value="A8" <?if(in_array('A8',$SubMenuGrant_array)){?>checked<?}?>> <label for="SubMenuGrant01_08">첨삭강사 리스트</label><br>
                                    <input type="checkbox" name="SubMenuGrant01" id="SubMenuGrant01_09" value="A9" <?if(in_array('A9',$SubMenuGrant_array)){?>checked<?}?>> <label for="SubMenuGrant01_09">개인정보 열람내역</label>
    							</td>
    							<td valign="top">
                                    <input type="checkbox" name="SubMenuGrant02" id="SubMenuGrant05_05" value="B5" <?if(in_array('B5',$SubMenuGrant_array)){?>checked<?}?>> <label for="SubMenuGrant05_05">학습관리</label><br>
                                    <input type="checkbox" name="SubMenuGrant02" id="SubMenuGrant05_06" value="B6" <?if(in_array('B6',$SubMenuGrant_array)){?>checked<?}?>> <label for="SubMenuGrant05_06">수강마감</label><br/>
                                    <input type="checkbox" name="SubMenuGrant02" id="SubMenuGrant02_01" value="B1" <?if(in_array('B1',$SubMenuGrant_array)){?>checked<?}?>> <label for="SubMenuGrant02_01">IP모니터링</label><br>
        							<input type="checkbox" name="SubMenuGrant02" id="SubMenuGrant02_02" value="B2" <?if(in_array('B2',$SubMenuGrant_array)){?>checked<?}?>> <label for="SubMenuGrant02_02">본인인증 모니터링</label><br/>
                                    <input type="checkbox" name="SubMenuGrant02" id="SubMenuGrant02_03" value="B3" <?if(in_array('B3',$SubMenuGrant_array)){?>checked<?}?>> <label for="SubMenuGrant02_03">일자별 학습시간 관리</label><br>
        							<input type="checkbox" name="SubMenuGrant02" id="SubMenuGrant02_04" value="B4" <?if(in_array('B4',$SubMenuGrant_array)){?>checked<?}?>> <label for="SubMenuGrant02_04">리포트 부정훈련</label><br>
        							<input type="checkbox" name="SubMenuGrant02" id="SubMenuGrant02_07" value="B7" <?if(in_array('B7',$SubMenuGrant_array)){?>checked<?}?>> <label for="SubMenuGrant02_07">과정 이수데이터 관리</label><br>
        							<input type="checkbox" name="SubMenuGrant02" id="SubMenuGrant02_08" value="B8" <?if(in_array('B8',$SubMenuGrant_array)){?>checked<?}?>> <label for="SubMenuGrant02_08">과목별 이수증</label>
    							</td>
    							<td valign="top">
        							...
        							<input type="checkbox" name="SubMenuGrant03" id="SubMenuGrant03_05" value="C5" <?if(in_array('C5',$SubMenuGrant_array)){?>checked<?}?>> <label for="SubMenuGrant03_05">문자/템플릿관리</label>
    							</td>
    							<td valign="top">
        							<input type="checkbox" name="SubMenuGrant04" id="SubMenuGrant04_01" value="D1" <?if(in_array('D1',$SubMenuGrant_array)){?>checked<?}?>> <label for="SubMenuGrant04_01">과정카테고리 관리</label><br>
        							<input type="checkbox" name="SubMenuGrant04" id="SubMenuGrant04_02" value="D2" <?if(in_array('D2',$SubMenuGrant_array)){?>checked<?}?>> <label for="SubMenuGrant04_02">기초차시 관리</label><br>
        							<input type="checkbox" name="SubMenuGrant04" id="SubMenuGrant04_03" value="D3" <?if(in_array('D3',$SubMenuGrant_array)){?>checked<?}?>> <label for="SubMenuGrant04_03">역량진단 문항관리</label><br>
        							<input type="checkbox" name="SubMenuGrant04" id="SubMenuGrant04_04" value="D4" <?if(in_array('D4',$SubMenuGrant_array)){?>checked<?}?>> <label for="SubMenuGrant04_04">역량진단관리</label><br>
        							<input type="checkbox" name="SubMenuGrant04" id="SubMenuGrant04_05" value="D5" <?if(in_array('D5',$SubMenuGrant_array)){?>checked<?}?>> <label for="SubMenuGrant04_05">만족도조사</label><br>
    							...
    							<td valign="top">
    								<input type="checkbox" name="SubMenuGrant05" id="SubMenuGrant05_01" value="E1" <?if(in_array('E1',$SubMenuGrant_array)){?>checked<?}?>> <label for="SubMenuGrant05_01">이러닝컨텐츠관리</label><br>
        							<input type="checkbox" name="SubMenuGrant05" id="SubMenuGrant05_02" value="E2" <?if(in_array('E2',$SubMenuGrant_array)){?>checked<?}?>> <label for="SubMenuGrant05_02">마이크로닝컨텐츠관리</label><br>
        							<input type="checkbox" name="SubMenuGrant05" id="SubMenuGrant05_03" value="E3" <?if(in_array('E3',$SubMenuGrant_array)){?>checked<?}?>> <label for="SubMenuGrant05_03">숏폼컨텐츠관리</label><br>
        							<input type="checkbox" name="SubMenuGrant05" id="SubMenuGrant05_04" value="E4" <?if(in_array('E4',$SubMenuGrant_array)){?>checked<?}?>> <label for="SubMenuGrant05_04">컨텐츠키워드관리</label><br>
        							<input type="checkbox" name="SubMenuGrant05" id="SubMenuGrant05_05" value="E5" <?if(in_array('E5',$SubMenuGrant_array)){?>checked<?}?>> <label for="SubMenuGrant05_05">PICK/TOP/NEW 컨텐츠 관리</label><br>
        							<input type="checkbox" name="SubMenuGrant05" id="SubMenuGrant05_06" value="E6" <?if(in_array('E6',$SubMenuGrant_array)){?>checked<?}?>> <label for="SubMenuGrant05_06">관심강의관리</label><br>
        							<input type="checkbox" name="SubMenuGrant05" id="SubMenuGrant05_07" value="E7" <?if(in_array('E7',$SubMenuGrant_array)){?>checked<?}?>> <label for="SubMenuGrant05_07">수강신청관리</label><br>
    							</td>
    						</tr>
    					</table>
    					<table width="100%" cellpadding="0" cellspacing="0" class="view_ty01">
    						<tr>										
    							<td><input type="checkbox" name="TopMenuGrant01" id="TopMenuGrant06" value="F" <?if(in_array('F',$TopMenuGrant_array)){?>checked<?}?>> <label for="TopMenuGrant06"><strong>커뮤니티관리</strong></label></td>
    						...
    						<tr>
    							<td valign="top">
        							<input type="checkbox" name="SubMenuGrant06" id="SubMenuGrant06_01" value="F1" <?if(in_array('F1',$SubMenuGrant_array)){?>checked<?}?>> <label for="SubMenuGrant06_01">공지사항</label><br>
        							<input type="checkbox" name="SubMenuGrant06" id="SubMenuGrant06_02" value="F2" <?if(in_array('F2',$SubMenuGrant_array)){?>checked<?}?>> <label for="SubMenuGrant06_02">자주묻는질문</label><br>
        							<input type="checkbox" name="SubMenuGrant06" id="SubMenuGrant06_03" value="F3" <?if(in_array('F3',$SubMenuGrant_array)){?>checked<?}?>> <label for="SubMenuGrant06_03">1:1상담/학습상담</label><br>
        							<input type="checkbox" name="SubMenuGrant06" id="SubMenuGrant06_04" value="F4" <?if(in_array('F4',$SubMenuGrant_array)){?>checked<?}?>> <label for="SubMenuGrant06_04">수강후기</label><br>
        							<input type="checkbox" name="SubMenuGrant06" id="SubMenuGrant06_05" value="F5" <?if(in_array('F5',$SubMenuGrant_array)){?>checked<?}?>> <label for="SubMenuGrant06_05">아카이빙</label><br>
        							<input type="checkbox" name="SubMenuGrant06" id="SubMenuGrant06_06" value="F6" <?if(in_array('F6',$SubMenuGrant_array)){?>checked<?}?>> <label for="SubMenuGrant06_06">부정제보</label>
    							</td>
    							<td valign="top">
        							<input type="checkbox" name="SubMenuGrant07" id="SubMenuGrant07_01" value="G1" <?if(in_array('G1',$SubMenuGrant_array)){?>checked<?}?>> <label for="SubMenuGrant07_01">사이트정보관리</label><br>
									<input type="checkbox" name="SubMenuGrant10" id="SubMenuGrant07_03" value="G2" <?if(in_array('G2',$SubMenuGrant_array)){?>checked<?}?>> <label for="SubMenuGrant07_03">팝업관리</label><br>
                                    <input type="checkbox" name="SubMenuGrant07" id="SubMenuGrant07_02" value="G3" <?if(in_array('G3',$SubMenuGrant_array)){?>checked<?}?>> <label for="SubMenuGrant07_02">백업 목록</label>
    							</td>
    						</tr>
    					</table>
					</td>
                    ...
                    <td>
						<table width="100%" cellpadding="0" cellspacing="0" class="view_ty01">
    						...
    						<tr>
    							...
    							<td valign="top">
                                    <input type="checkbox" name="SubMenuGrant02" id="SubMenuGrant05_05" value="B5" <?if(in_array('B5',$SubMenuGrant_array)){?>checked<?}?>> <label for="SubMenuGrant05_05">학습관리</label>
    							</td>
    							<td valign="top">
        							<input type="checkbox" name="SubMenuGrant03" id="SubMenuGrant03_02" value="C2" <?if(in_array('C2',$SubMenuGrant_array)){?>checked<?}?>> <label for="SubMenuGrant03_02">문자발송내역</label><br>
        							<input type="checkbox" name="SubMenuGrant03" id="SubMenuGrant03_03" value="C3" <?if(in_array('C3',$SubMenuGrant_array)){?>checked<?}?>> <label for="SubMenuGrant03_03">메일발송내역(교육담당자)</label><br>
    							...
    							<td valign="top">
    								<input type="checkbox" name="SubMenuGrant05" id="SubMenuGrant05_01" value="E1" <?if(in_array('E1',$SubMenuGrant_array)){?>checked<?}?>> <label for="SubMenuGrant05_01">이러닝컨텐츠관리</label><br>
        							<input type="checkbox" name="SubMenuGrant05" id="SubMenuGrant05_02" value="E2" <?if(in_array('E2',$SubMenuGrant_array)){?>checked<?}?>> <label for="SubMenuGrant05_02">마이크로닝컨텐츠관리</label><br>
        							<input type="checkbox" name="SubMenuGrant05" id="SubMenuGrant05_03" value="E3" <?if(in_array('E3',$SubMenuGrant_array)){?>checked<?}?>> <label for="SubMenuGrant05_03">숏폼컨텐츠관리</label>
    							</td>
    							<td valign="top">
        							<input type="checkbox" name="SubMenuGrant06" id="SubMenuGrant06_01" value="F1" <?if(in_array('F1',$SubMenuGrant_array)){?>checked<?}?>> <label for="SubMenuGrant06_01">공지사항</label><br>
        							<input type="checkbox" name="SubMenuGrant06" id="SubMenuGrant06_02" value="F2" <?if(in_array('F2',$SubMenuGrant_array)){?>checked<?}?>> <label for="SubMenuGrant06_02">자주묻는질문</label><br>
        							<input type="checkbox" name="SubMenuGrant06" id="SubMenuGrant06_03" value="F3" <?if(in_array('F3',$SubMenuGrant_array)){?>checked<?}?>> <label for="SubMenuGrant06_03">1:1상담/학습상담</label><br>
        							<input type="checkbox" name="SubMenuGrant06" id="SubMenuGrant06_04" value="F4" <?if(in_array('F4',$SubMenuGrant_array)){?>checked<?}?>> <label for="SubMenuGrant06_04">수강후기</label>
    							</td>
    						</tr>
    					</table>
					</td>
