			...
			<form name="search" id="search" method="POST">
    			...
    			<div class="neoSearch">
                    ...
                    <ul class="search">
                        ...
                        <li><span class="item01">평가 베낀</span>
    						<select name="TestCopy" id="TestCopy" style="width:150px">
    							<option value="">전체</option>
    							<option value="D">베낀답안의심</option>
    							<option value="Y">베낀답안</option>
    						</select>
                        </li>
                        <li><span class="item01">과제 베낀</span>
                    ...
                    <!-- btn -->
    			  	<div class="mt10 tc pb5">
    					...
    					<button type="button" name="ExcelBtn" id="ExcelBtn" class="btn btn_Green line" style="width:200px;" onclick="StudyIPExcelBackUp();"><i class="fas fa-file-excel"></i> 검색 결과 엑셀 출력</button>
