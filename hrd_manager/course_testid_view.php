	...
	<div class="contentBody">
		...
		<div class="conZone">
			<table width="100%" cellpadding="0" cellspacing="0" class="list_ty01 gapT20">
				...
				<?
    			$i = 1;
    			$SQL = "SELECT a.*, b.LectureStart, b.LectureEnd, AES_DECRYPT(UNHEX(a.Mobile),'$DB_Enc_Key') AS Mobile 
                        FROM Member AS a 
                        LEFT OUTER JOIN Study AS b ON a.ID=b.ID 
                        WHERE a.TestID='Y' AND a.TestLectureCode='$LectureCode' ORDER BY a.ID ASC, a.RegDate ASC";
