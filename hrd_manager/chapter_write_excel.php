...
//-->
                ...
                <!-- 입력 -->
				<form name="ExcelUpForm" method="post" action="chapter_excel_upload.php" enctype="multipart/form-data" target="ScriptFrame">
                <table width="100%" cellpadding="0" cellspacing="0" class="view_ty01">
                  ...
                  <tr>
                    <th>등록 샘플</th>
                    <td>
                		<input type="button" value="양식 다운로드" class="btn_inputLine01" onclick="location.href='./sample/컨텐츠_하위_차시.xlsx'">&nbsp;&nbsp;&nbsp;&nbsp;
          				<input type="button" value="샘플 다운로드" class="btn_inputLine01" onclick="location.href='./sample/컨텐츠_하위_차시(샘플).xlsx'">
					</td>
                  </tr>
                  <tr>
                    <th>파일 등록</th>
...
$(window).load(function() {
	ChapterExcelUploadListRoading('A');
});
//-->
</script>
	<!-- Footer -->
