...
<link rel="stylesheet" href="/hrd_manager/css/style2.css?v230918" type="text/css">
<link rel="stylesheet" type="text/css" href="/hrd_manager/include/jquery-ui.css" />
<script type="text/javascript" src="/hrd_manager/include/jquery-1.11.0.min.js"></script>
<script type="text/javascript" src="/hrd_manager/include/jquery-ui.js"></script>
<style>
...
<div id="certi_print_wrap" class="certi_print_wrap" style="width:830px">
	...
	if($CompanyNameA)  $whereA[] = "c.CompanyName = '$CompanyNameA'";
	$whereA[] = "s.LectureStart='$LectureStartA'";
	$whereA[] = "s.LectureEnd='$LectureEndA'";	
	$whereA = implode(" AND ",$whereA);
	if($whereA) $whereA = "WHERE $whereA";
	
    $SqlA = "SELECT s.CompanyCode, s.LectureCode , s.LectureStart , s.LectureEnd , c.CompanyName 
    ...
    while($ROWA = mysqli_fetch_array($QUERYA)){
    	...
    	$SqlC = "SELECT * FROM Course WHERE LectureCode = '$LectureCode'";
    	//echo $SqlC;
	...
	<div style="page-break-after: always;">
		<div class="certi_print_info">
			<div class="infoArea">
				...
				<?
				$SQL = "SELECT LectureCode, ContentsName FROM Course WHERE LectureCode = '$LectureCode'";
				...
				<div class="tableArea" style="text-align:center; margin-top:120px">
					<table style="margin:0 auto; border:0; font-weight:bold;">
						...
						<td style="border:0;text-align:left; width:220px;">
							...
							<div style="font-size:28px;line-height:36px;"><?=$CertSiteName?></div>
						</td>
			...
			<div class="infoArea">
				...
				<div style="text-align:left; font-size:20px; font-weight:bold; margin-bottom:10px;padding-bottom: 7px; border-bottom: 5px solid #0000FF;">2. 교육생별 수료 현황</div>
					...
					<table class="mb10">
						...
						<?
						$SQL3 = "SELECT a.Seq, a.Progress, a.PassOK, a.Price, a.rPrice, m.Name, AES_DECRYPT(UNHEX(m.BirthDay),'$DB_Enc_Key') AS BirthDay 
					...
					<table class="mb10">
						...
						<?
						$SQL4 = "SELECT a.Seq, a.Progress, a.PassOK, a.Price, a.rPrice, m.Name, AES_DECRYPT(UNHEX(m.BirthDay),'$DB_Enc_Key') AS BirthDay 
