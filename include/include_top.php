...
<script type="text/javascript" src="/include/sso_localstorage.js?t=<?=date('YmdHis')?>"></script>
...
<script type="text/javascript">
    window.__HRDE_SSO_USER_ID = "<?=!empty($_SESSION['LoginMemberID']) ? $_SESSION['LoginMemberID'] : $_SESSION['LoginAdminID']?>";
</script>
<? } ?>
<script type="text/javascript">
<!--
